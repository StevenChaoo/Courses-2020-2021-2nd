...
**This blog is used for recording the notes and some code of my lessons in UIR. Some sensitive information is not uploaded which have been recorded in `.gitignore` file.**

#### Notes

1. [Internet of Things](Notes/IOT.md)
2. [Network Security Technology](Notes/NetworkSecurityTechnology.md)
3. [Social Network Analysis](Notes/SocialNetworkAnalysis.md)

#### Code

1. [Object-Oriented Programming](OOP/Code/README.md)
2. [Cryptography](Notes/Cryptography.md)
